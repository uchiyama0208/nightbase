  ...
  return (
    <div>
        ...
        <div className="container grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="glass-panel space-y-4 p-6">
            <div className="rounded-2xl border border-neutral-100 bg-white/80 p-6 shadow-soft">
              <p className="text-sm font-semibold text-neutral-500">今日のKPI</p>
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div>
                  <p className="text-xs text-neutral-500">売上</p>
                  <p className="text-2xl font-semibold text-[#111111]">¥820,000</p>
                  <p className="text-xs text-primary">先週比 +12%</p>
                </div>
                <div>
                  <p className="text-xs text-neutral-500">VIP来店</p>
                  <p className="text-2xl font-semibold text-[#111111]">38</p>
                  <p className="text-xs text-primary">+6 件</p>
                </div>
              </div>
            </div>
            <div className="rounded-2xl border border-neutral-100 bg-white/80 p-6 shadow-soft">
              <p className="text-sm font-semibold text-neutral-500">キャストコンディション</p>
      ...
      <section className="bg-white py-20">
        <div className="container space-y-10">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-[#111111] sm:text-4xl">{caseStudies.title}</h2>
