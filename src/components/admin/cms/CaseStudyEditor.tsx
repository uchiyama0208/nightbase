        ...
        <section className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-6">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="company" placeholder="NightBase 銀座店" {...form.register("company_name")} />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <Textarea id="summary" rows={3} placeholder="導入概要を入力" {...form.register("summary")} />
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Textarea id="problems" rows={6} placeholder="箇条書きで入力" {...form.register("problems")} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="solutions" className="text-slate-300">
                NightBase の活用
              </Label>
              <Textarea id="solutions" rows={6} placeholder="導入内容を入力" {...form.register("solutions")} />
            </div>
          </div>
          <div className="space-y-2">
