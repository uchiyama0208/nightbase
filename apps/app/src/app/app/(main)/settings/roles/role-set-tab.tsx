...
export function RoleSetTab({ forRole, roles: initialRoles, profiles: initialProfiles, adminProfiles: initialAdminProfiles, currentProfileId, isAdmin, storeFeatures }: RoleSetTabProps) {
        ...
        <div className="space-y-4">
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-between px-4 py-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                                >
                                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                        <Users className="h-4 w-4" />
            ...
            {forRole === "staff" && initialAdminProfiles && (
                <Dialog open={adminMembersOpen} onOpenChange={setAdminMembersOpen}>
                    <DialogContent className="sm:max-w-md max-h-[80vh] overflow-y-auto rounded-2xl border border-gray-200 bg-white p-0 dark:border-gray-800 dark:bg-gray-900">
                            ...
                            {filteredAddableProfiles.length === 0 ? (
                                ...
                                filteredAddableProfiles.map((profile) => (
                                    <button
                                        ...
                                        disabled={loading}
                                        className="w-full flex items-center gap-3 rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                                    >
