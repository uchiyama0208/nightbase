              ...
              {kanaGroups.map((group) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 px-6 rounded-xl ${cardBgClass} border-2 ${borderClass} hover:border-blue-400 ${isDarkMode ? "hover:bg-slate-700" : "hover:bg-blue-50"} flex items-center justify-between transition-all`}
                  >
