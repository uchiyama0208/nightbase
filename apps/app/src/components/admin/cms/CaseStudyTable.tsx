    ...
    <Table className="min-w-full">
      <TableHeader>
        <TableRow className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-xs uppercase tracking-[0.25em] text-slate-500 dark:text-slate-400">
          <TableHead className="px-6 text-center">事例タイトル</TableHead>
            ...
            >
              ...
              <TableCell className="text-center">
                <Badge
                  ...
                  className={cn(
                    "px-3 py-1 text-xs",
                    item.status === "published" ? "bg-emerald-100 text-emerald-900 dark:bg-emerald-900 dark:text-emerald-300" : "bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-300"
                  )}
                >
