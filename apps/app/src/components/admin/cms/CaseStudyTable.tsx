            ...
            >
              ...
              <TableCell className="text-center">
                <Badge
                  ...
                  className={cn(
                    "px-3 py-1 text-xs",
                    item.status === "published" ? "bg-emerald-100 text-emerald-900 dark:bg-emerald-900 dark:text-emerald-300" : "bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-300"
                  )}
                >
